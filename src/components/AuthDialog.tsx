          ...
          >
            {socialLoading === 'apple' ? (
              ...
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.05 13.5c-.91 2.92-.6 4.58 1.25 5.74 1.85 1.16 4.75 0.28 6.54-2.46 1.79-2.74 1.27-6.61-1.3-7.95-.96-.5-2.07-.51-2.84.15-.23.2-.42.46-.58.75-1.21-2.06-2.78-3.07-4.78-3.07-3.57 0-6.58 3.01-6.58 6.73s3.01 6.73 6.73 6.73c1.5 0 2.92-.5 4.08-1.43zm7.59-5.09c.64.38 1.18 1.03 1.18 2.14 0 1.11-.54 1.76-1.18 2.14-.64.38-1.8.47-2.46.06-.66-.41-.84-1.21-.84-2.2 0-.99.18-1.79.84-2.2.66-.41 1.82-.32 2.46.06z"/>
              </svg>
            )}
